...
public:
    ...
    void writePidResponse(uint16_t requestPid, uint8_t numberOfBytes, const char * value);

    void writePidResponse(uint16_t requestPid, uint8_t numberOfBytes, uint32_t value);
